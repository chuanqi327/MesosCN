...
![marathon5](../mesos单机poc/marathon-top-5.png)
    ...
    Updated 最新任务操作时间
##### 3.1.1.7 查看任务数据信息
![marathon6](../mesos单机poc/marathon-top-6.png)
...
#### 3.2.5 检查
![nginx-1](../mesos单机poc/marathon-nginx-1.png)
...
![bamboo2](../mesos单机poc/bamboo-2.png)
##### 3.2.7.3 直接访问主机80端口
    到游览器访问http://测试主机ip
